...
export function AppHeader({ employees = [] }: { employees?: any[] }) {
  ...
  return (
    /* The header itself stays w-full so the border-b is a FULL LINE */
    <header className="sticky top-0 z-50 w-full border-b border-zinc-800 bg-zinc-950/95 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/80">
      ...
      {/* INNER CONTAINER: 
         - max-w-7xl + mx-auto: Aligns logo/nav with your table content below.
         - px-4/6/8: Matches the responsive padding of your main layout.
      */}
